     ...
     <?php } ?>
         <div class="col-md-10 col-md-offset-1">
          <?php if ($totalRows_ConsultaFuncion==0){ ?>
            <h3>Debe ingresar una <?php if($_tipo==2){ ?> Poliza de Ingreso,<?php } elseif($_tipo==3) { ?> Poliza de Egreso,<?php } elseif($_tipo==4) { ?> Poliza de Cheque,<?php } ?> <a href="poliza_add.php">click aqui para agregar</a> </h3>
          <?php }else { ?>
